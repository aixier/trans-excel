...
class ConnectionManager:
    ...
    async def send_initial_status(self, websocket: WebSocket, session_id: str):
        ...
        try:
            ...
            # Get session info - PipelineSession is an object, not a dict
            session_data = pipeline_session_manager.get_session(session_id)

            # Extract status from PipelineSession object
            if session_data:
